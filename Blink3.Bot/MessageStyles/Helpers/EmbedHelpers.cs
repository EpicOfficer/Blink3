...
public static class EmbedHelpers
{
    ...
    /// <returns></returns>
    private static Embed CreateEmbed(EmbedStyle style, string? name = null, string message = "",
    ...
    {
        return CreateEmbed(new PlainStyle(), name, message, fields);
    }
    ...
    {
        return CreateEmbed(new SuccessStyle(), name, message, fields);
    }
    ...
    {
        return CreateEmbed(new InfoStyle(), name, message, fields);
    }
    ...
    {
        return CreateEmbed(new ErrorStyle(), name, message, fields);
    }
}