...
{
    [Required] public DiscordConfig Discord { get; init; } = null!;

    [Required] public ConnectionStringsConfig ConnectionStrings { get; init; } = null!;
...
public record DiscordConfig
{
    ...
    [Required] public string BotToken { get; init; } = null!;
...
{
    [Required] public string DefaultConnection { get; init; } = null!;
}
